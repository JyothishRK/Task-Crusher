    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8 sm:mb-12 px-4">
              <Link 
                to="/signup" 
                className="group bg-primary-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-primary-700 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl flex items-center space-x-2 w-full sm:w-auto justify-center"
              >
              ...
              <button 
                ...
                className="group flex items-center space-x-2 text-gray-600 hover:text-primary-600 transition-colors duration-200 w-full sm:w-auto justify-center"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors duration-200">
                  <Play className="h-4 w-4 sm:h-5 sm:w-5 text-primary-600 ml-1" />
                </div>
          ...
          <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative max-w-4xl mx-auto px-4">
              <div className="bg-gradient-to-r from-primary-100 to-purple-100 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                  {features.map((feature, index) => (
                    ...
                    >
                      <div className="text-primary-600 mb-3 sm:mb-4 flex justify-center">{feature.icon}</div>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          {/* Icon Container */}
          <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-r from-primary-100 to-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 md:mb-8 animate-pulse hover:animate-bounce transition-all duration-300 hover:scale-110 hover:shadow-lg">
            <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-primary-600 animate-pulse" />
          </div>
          ...
          <div className="relative mt-6 sm:mt-8 md:mt-12 hidden sm:block">
            <div className="absolute -top-4 -left-4 sm:-left-8 w-3 h-3 sm:w-4 sm:h-4 bg-primary-200 rounded-full animate-float-slow"></div>
            <div className="absolute -top-6 sm:-top-8 -right-6 sm:-right-12 w-2 h-2 sm:w-3 sm:h-3 bg-purple-200 rounded-full animate-float-medium"></div>
            <div className="absolute -bottom-4 sm:-bottom-6 left-6 sm:left-12 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-primary-300 rounded-full animate-float-fast"></div>
            <div className="absolute -bottom-3 sm:-bottom-4 -right-6 sm:-right-8 w-2 h-2 sm:w-3 sm:h-3 bg-purple-300 rounded-full animate-float-slow"></div>
          </div>
          
          {/* Mobile-friendly floating elements */}
          <div className="relative mt-6 sm:hidden">
            <div className="flex justify-center space-x-4">
              <div className="w-2 h-2 bg-primary-200 rounded-full animate-float-slow"></div>
              <div className="w-2 h-2 bg-purple-200 rounded-full animate-float-medium"></div>
              <div className="w-2 h-2 bg-primary-300 rounded-full animate-float-fast"></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
          ...
          <div className="relative bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gradient-to-r from-primary-50 to-purple-50 rounded-xl">
                ...
                <div className="flex flex-col gap-3">
                  <Link
                    to="/signup"
                    onClick={() => setShowDemo(false)}
                    className="bg-primary-600 text-white px-4 sm:px-6 py-3 rounded-lg font-medium hover:bg-primary-700 transition-colors duration-200 text-center text-sm sm:text-base"
                  >
                    Start Free Trial
                  </Link>
                  <button
